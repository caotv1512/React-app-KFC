...
export default function Amin() {
    ...
    React.useEffect(() => {
        axios.get("https://db-kfc.onrender.com/product").then((response) => {
    ...
    const handleDelete = (id) => {
        axios
            .delete(`https://db-kfc.onrender.com/product/${id}`)
            .then(() => {
    ...
    React.useEffect(() => {
        axios
            .get("https://db-kfc.onrender.com/users")
            .then((response) => {
    ...
    //     axios
    //         .delete(`https://db-kfc.onrender.com/users/${id}`)
    //         .then(() => {
    ...
    const handleLockAccount = (id) => {
        axios
            .patch(`https://db-kfc.onrender.com/users/${id}`, { locked: true })
            .then(() => {
    ...
    const handleUnlockAccount = (id) => {
        axios
            .patch(`https://db-kfc.onrender.com/users/${id}`, { locked: false })
            .then(() => {
                const updatedUsers = user.map((userItem) => {
                    if (userItem.id === id) {
