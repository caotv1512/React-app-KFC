...
//     useEffect(() => {
//         axios.get("https://db-kfc.onrender.com/users").then((response) => {
...
//         axios
//             .put(`https://db-kfc.onrender.com/users/${id}`, { locked: true })
//             .then(() => {
...
//         axios
//             .put(`https://db-kfc.onrender.com/users/${id}`, { locked: false })
//             .then(() => {
//                 const updatedUsers = user.map((userItem) => {
//                     if (userItem.id === id) {
